<?php /*a:1:{s:62:"/Applications/MAMP/htdocs/tp6/app/admin/view/goods/recode.html";i:1604196803;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    layui.use(['element','table'], function(){
        ...
        table.render({
            ...
            ,url: "<?php echo url('goods/recodeList'); ?>"
            ,cols: [[ //表头
        ...
        table.on('toolbar(table_list)',function (obj) {
            ...
            if(layEvent === 'add'){
                ...
                window.location.href = "<?php echo url('cates/add'); ?>";
            }
        });
